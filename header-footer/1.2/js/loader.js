...
console.log(CatalogueListTypeColumnCount);
			  ...
			  $('head').append('<link rel="icon" type="image/x-icon" href="https://www.nationalgeographic.com/etc/designs/platform/refresh/images/favicon.ico">');
